...
- to run the build script, Apache Ant 1.7 is required

- doxygen and pas2dox are required to build the documentation (copy pas2dox.exe must be the "make" folder)